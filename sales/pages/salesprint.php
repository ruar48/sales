...
<a class="btn btn-primary" href="javascript:Clickheretoprint()" style="font-size:20px" ;>Print</a>|<a
    class="btn btn-primary" href="home.php" style="font-size:20px" ;>Back</a>
<?php
$invoice=$_GET['id'];
include('connect.php');
...
?>
                    <table border="1" cellpadding="4" cellspacing="0"
                        style="font-family: arial; font-size: 15px;text-align:left;width : 100%;">
                        <tr>
