...
<body>
    ...
    <div id="page-wrapper">
        <div class="row">
            ...
            <div id="maintable">
                ...
                <form action="incoming.php" method="post" class="form-group" id="productForm">
                    ...
                    <select name="product" style="width:500px;" class="chzn-select" id="productDropdown">
                        <option></option>
                        <?php
    include('connect.php');
    ...
    ?>
                    ...
                    $(function() {
                        $(".chzn-select").chosen({
                            max_selected_options: Infinity // Set to a high number or Infinity to keep the dropdown always open
                        });

                        // Manually trigger the chosen:open event
                        $(".chzn-select").trigger("chosen:open");
                    });
                    </script>
                    ...
                    <input type="text" name="vat" value="0" class="form-control" autocomplete="off"
                        style="width: 100px; padding-top: 6px; padding-bottom: 6px; margin-right: 4px;" />
                    <br>
                    <input type="submit" class="btn btn-primary" value="add product" class="form-control"
                        style="width: 123px;" />
                </form>
                ...
                <a rel="facebox" class="btn btn-primary"
                    href="checkout.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&cashier=<?php echo $session_cashier_name?>&p_amount=<?php echo $ccc?>">Check
                    Out</a>
